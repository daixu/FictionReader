 ...
 */
package com.shangame.fiction.book.pageflip;
...
public class PageFlip {
    ...
    private final static float WIDTH_RATIO_OF_RESTORE_FLIP = 0.1f;
    ...
    public boolean isAnimating() {
        boolean isResume = ReadParameter.getInstance().isResume();
        if (isResume) {
            return false;
        }
