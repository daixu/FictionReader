...
public class Poster1Fragment extends BaseFragment {
    private static final String ARG_PARAM1 = "param1";
    private String imagePath;
    private ConstraintLayout mLayoutContent1;
    private ProgressDialog mProgressDialog;

    public Poster1Fragment() {
    }

    public static Poster1Fragment newInstance(int param1) {
        Poster1Fragment fragment = new Poster1Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View contentView = inflater.inflate(R.layout.fragment_poster1, container, false);
