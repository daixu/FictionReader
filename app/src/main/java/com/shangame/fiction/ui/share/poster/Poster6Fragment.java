...
public class Poster6Fragment extends BaseFragment {
    ...
    public Poster6Fragment() {
    }

    public static Poster6Fragment newInstance(int param1) {
        Poster6Fragment fragment = new Poster6Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View contentView = inflater.inflate(R.layout.fragment_poster6, container, false);
        initView(contentView);
        imagePath = FileManager.getInstance(mContext).getCacheDir() + File.separator + "share6.jpeg";
        return contentView;
    }
    ...
    private void initView(View contentView) {
        ...
        Bitmap qrBitmap = QrEncodeUtils.createImage(url, DensityUtil.dip2px(mContext, 100), DensityUtil.dip2px(mContext, 100), logo);
