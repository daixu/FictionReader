...
import com.shangame.fiction.ui.reader.local.bean.ChapterInfoBean;
...
public class BookRepository {
    ...
    private BookRepository() {
        mSession = DbManager.getDaoSession(AppContext.getContext());
    ...
    public void saveCollBookWithAsync(final CollBookBean bean) {
        //启动异步存储
        mSession.startAsyncSession().runInTx(new Runnable() {
            @Override
            public void run() {
    ...
    public List<BookRecordBean> getBookRecordList() {
        return mSession.getBookRecordBeanDao()
                .queryBuilder()
    ...
    /************************************************************/
    public Single<Void> deleteCollBookInRx(final CollBookBean bean) {
