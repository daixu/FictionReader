...
public class Poster4Fragment extends BaseFragment {
    ...
    public Poster4Fragment() {
    }

    public static Poster4Fragment newInstance(int param1) {
        Poster4Fragment fragment = new Poster4Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View contentView = inflater.inflate(R.layout.fragment_poster4, container, false);
        initView(contentView);
        imagePath = FileManager.getInstance(mContext).getCacheDir() + File.separator + "share4.jpeg";
        return contentView;
    }
