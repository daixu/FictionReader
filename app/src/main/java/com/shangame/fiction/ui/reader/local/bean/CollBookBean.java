...
public class CollBookBean implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeList(this.bookChapterList);
    }
    ...
    protected CollBookBean(Parcel in) {
        ...
        this.bookChapterList = new ArrayList<BookChapterBean>();
        in.readList(this.bookChapterList, BookChapterBean.class.getClassLoader());
    }

    public static final Parcelable.Creator<CollBookBean> CREATOR = new Parcelable.Creator<CollBookBean>() {
        @Override
