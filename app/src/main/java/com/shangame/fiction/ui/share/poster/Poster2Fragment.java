...
public class Poster2Fragment extends BaseFragment {
    private static final String ARG_PARAM1 = "param1";
    private String imagePath;
    private ConstraintLayout mLayoutContent1;
    private ProgressDialog mProgressDialog;

    public Poster2Fragment() {
    }

    public static Poster2Fragment newInstance(int param1) {
        Poster2Fragment fragment = new Poster2Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View contentView = inflater.inflate(R.layout.fragment_poster2, container, false);
        initView(contentView);
        imagePath = FileManager.getInstance(mContext).getCacheDir() + File.separator + "share2.jpeg";
        return contentView;
    }
