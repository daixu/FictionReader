...
public class Poster3Fragment extends BaseFragment {
    ...
    public Poster3Fragment() {
    }

    public static Poster3Fragment newInstance(int param1) {
        Poster3Fragment fragment = new Poster3Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View contentView = inflater.inflate(R.layout.fragment_poster3, container, false);
        initView(contentView);
        imagePath = FileManager.getInstance(mContext).getCacheDir() + File.separator + "share3.jpeg";
        return contentView;
    }
    ...
    private void initView(View contentView) {
        ...
        Bitmap qrBitmap = QrEncodeUtils.createImage(url, DensityUtil.dip2px(mContext, 110), DensityUtil.dip2px(mContext, 110), logo);
