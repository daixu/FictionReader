 ...
 * 已发布章节
 */
public class PublishedFragment extends BaseFragment implements ChapterListContacts.View {
    ...
    private TextView mTextChapterCount;

    private RelativeLayout mLayoutChapterCount;

    public PublishedFragment() {
        // Required empty public constructor
    }

    public static PublishedFragment newInstance(int bookId, String bookName) {
    ...
    private void loadData(int pageIndex) {
        long userId = UserInfoManager.getInstance(mContext).getUserid();
        mPresenter.getChapter(userId, mBookId, pageIndex, 20, 0);
    }
    ...
    private void initView(View contentView) {
        ...
        mAdapter = new ChapterItemAdapter(R.layout.item_chapter_item, mData, 1);
        recyclerView.setLayoutManager(new LinearLayoutManager(mActivity, LinearLayoutManager.VERTICAL, false));
        recyclerView.setAdapter(mAdapter);
        mLayoutChapterCount = contentView.findViewById(R.id.layout_chapter_count);
        mLayoutChapterCount.setVisibility(View.VISIBLE);
        mTextChapterCount = contentView.findViewById(R.id.text_chapter_count);
    }
    ...
    public void getChapterSuccess(ChapterResponse response) {
        ...
        mLayoutChapterCount.setVisibility(View.VISIBLE);
        String chapterCount = "共" + response.records + "章";
        mTextChapterCount.setText(chapterCount);
        if (mPageIndex == 1) {
            mData.clear();
        }
    ...
    public void getChapterEmpty() {
        mSmartRefreshLayout.finishRefresh();
        mSmartRefreshLayout.finishLoadMore();
        mLayoutChapterCount.setVisibility(View.GONE);
    }
