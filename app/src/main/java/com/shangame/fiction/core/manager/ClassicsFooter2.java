...
/**
 * Create by Speedy on 2019/4/20
 */
public class ClassicsFooter2 extends InternalClassics<ClassicsFooter> implements RefreshFooter {
    ...
    public ClassicsFooter2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ClassicsFooter2(Context context, AttributeSet attrs, int defStyleAttr) {
...
//    }
    ...
    public int onFinish(@NonNull RefreshLayout layout, boolean success) {
        if (!mNoMoreData) {
            mTitleText.setText(success ? "" : REFRESH_FOOTER_FAILED);
