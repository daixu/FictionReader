...
public final class AppUtils {
    ...
    public static boolean installAppSilent(final File file,
        ...
        if (commandResult.successMsg != null
            ...
            Logger.e("AppUtils", "installAppSilent successMsg: " + commandResult.successMsg +
    ...
    public static boolean uninstallAppSilent(final String packageName,
        ...
        if (commandResult.successMsg != null
            ...
            Logger.e("AppUtils", "uninstallAppSilent successMsg: " + commandResult.successMsg +
                    ", errorMsg: " + commandResult.errorMsg);
            return false;
        }
    }
    ...
    private static Intent getInstallAppIntent(final File file, final boolean isNewTask) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            String authority = AppConfig.PROVIDER_AUTHORITIES;
    ...
    private static String getForegroundProcessName() {
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) {
            ...
            Logger.i("ProcessUtils", list.toString());
            if (list.size() <= 0) {
                Logger.i("ProcessUtils",
