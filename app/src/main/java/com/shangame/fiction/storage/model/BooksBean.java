...
public class BooksBean implements Parcelable {
    ...
    public String path;
    @Generated(hash = 2132283283)
    public BooksBean(String _id, long bookId, int chapterNumber, long chapterId,
            String bookCover, String bookName, String author, int updState,
            int recState, boolean isPicked, int updChapter, int updating,
            long lastModifyTime, boolean isLocal, String path) {
        this._id = _id;
        this.bookId = bookId;
