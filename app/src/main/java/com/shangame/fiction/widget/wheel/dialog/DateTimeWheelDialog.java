...
import com.shangame.fiction.widget.wheel.base.WheelItemView;
import com.shangame.fiction.widget.wheel.base.WheelView;
    ...
    private void initView() {
        ...
        tvCancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!cancelCallBack.callBack(v, selectedCalendar.getTime())) {
                    dismiss();
                }
            }
        });
        tvOK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!okCallBack.callBack(v, selectedCalendar.getTime())) {
                    dismiss();
                }
            }
        });
