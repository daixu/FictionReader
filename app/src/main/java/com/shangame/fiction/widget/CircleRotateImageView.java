...
public class CircleRotateImageView extends AppCompatImageView {
    ...
    private void init() {
        ...
        if (elevationSupported()) {
            ...
            OvalShape oval = new CircleRotateImageView.OvalShadow(mShadowRadius);
    ...
    public CircleRotateImageView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CircleRotateImageView, defStyle, 0);

        mBorderWidth = a.getDimensionPixelSize(R.styleable.CircleRotateImageView_civ_rotate_border_width, DEFAULT_BORDER_WIDTH);
        mBorderColor = a.getColor(R.styleable.CircleRotateImageView_civ_rotate_border_color, DEFAULT_BORDER_COLOR);
        mBorderOverlay = a.getBoolean(R.styleable.CircleRotateImageView_civ_rotate_border_overlay, DEFAULT_BORDER_OVERLAY);
        mCircleBackgroundColor = a.getColor(R.styleable.CircleRotateImageView_civ_rotate_circle_background_color, DEFAULT_CIRCLE_BACKGROUND_COLOR);
    ...
    public void startRotateAnimation2() {
        if (null != mRotateAnimator) {
            mRotateAnimator.cancel();
            mRotateAnimator.start();
        } else {
    ...
    private class OvalShadow extends OvalShape {
        ...
        public void draw(Canvas canvas, Paint paint) {
            final int viewWidth = CircleRotateImageView.this.getWidth();
            final int viewHeight = CircleRotateImageView.this.getHeight();
