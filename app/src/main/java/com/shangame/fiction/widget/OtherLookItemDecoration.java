 ...
 */
public class OtherLookItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if(layoutManager instanceof GridLayoutManager){
            ...
            if(childPosition % 7 >= 3){

                childPosition = childPosition %7 -3;
    ...
    public OtherLookItemDecoration(int space) {
        this.mSpace = space;
    }
