package com.shangame.fiction.widget.gallery;
...
import com.shangame.fiction.widget.gallery.util.DLog;
import com.shangame.fiction.widget.gallery.util.ThreadUtils;
...
public class GalleryRecyclerView extends RecyclerView implements View.OnTouchListener, GalleryItemDecoration.OnItemSizeMeasuredListener {
    ...
    public int getScrolledPosition() {
        if (mScrollManager == null) {
            ...
            return mScrollManager.getScrolledPosition();
        }
    }
