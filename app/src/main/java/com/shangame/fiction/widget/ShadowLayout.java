...
public class ShadowLayout extends ViewGroup {
    ...
    public ShadowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int shadowColor = a.getColor(R.styleable.ShadowLayout_containerShadowColor, Color.RED);
//        int shadowColor = Color.RED;
        float shadowRadius = a.getDimension(R.styleable.ShadowLayout_containerShadowRadius, 0);
        deltaLength = a.getDimension(R.styleable.ShadowLayout_containerDeltaLength, 0);
        cornerRadius = a.getDimension(R.styleable.ShadowLayout_containerCornerRadius, 0);
        float dx = a.getDimension(R.styleable.ShadowLayout_deltaX, 0);
        float dy = a.getDimension(R.styleable.ShadowLayout_deltaY, 0);
        drawShadow = a.getBoolean(R.styleable.ShadowLayout_enable, true);
        a.recycle();
