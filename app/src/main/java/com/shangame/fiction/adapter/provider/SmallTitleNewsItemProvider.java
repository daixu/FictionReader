 ...
 * @description: 小标题布局
 */
public class SmallTitleNewsItemProvider extends BaseNewsItemProvider {

    public SmallTitleNewsItemProvider() {
        super();
    }

    @Override
    public int viewType() {
        return ChoiceListAdapter.SMALL_TITLE_NEWS;
    }

    @Override
    public int layout() {
        return R.layout.item_small_title_news;
    }
    ...
    protected void setData(BaseViewHolder helper, NewsResp.DataBean.PageDataBean news) {
        ...
        String bookName = "《" + news.bookname + "》";
        helper.setText(R.id.text_book_name, bookName);
